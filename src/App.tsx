...
import { ResourceEditorPage } from './components/ResourceEditorPage';
...
const ERP_MODULE_LABELS: { [id: string]: string } = {
  ...
  'accompanying-person-single': 'Accompanying person (single)',
  'accompanying-persons': 'Accompanying persons',
  'attendance': 'Attendance',
  'attendance-time': 'Attendance / time',
  'attendance-month': 'Attendance by month',
  'attendance-tasks': 'Attendance with tasks and functions',
  'attendance-timeslots': 'Attendance with Timeslots',
  'criteria': 'Criteria',
  ...
  'postcode-range': 'Postcode range',
  'responsible-persons': 'Responsible persons',
  'services': 'Services',
  'tasks-functions': 'Tasks / functions',
  'timeslots-functions': 'Time slots / functions',
  'travel': 'Travel',
  'visa-invitation': 'Visa invitation',
  'mobile-app-pin': 'Mobile app pin codes',
  'invoices': 'Invoices',
