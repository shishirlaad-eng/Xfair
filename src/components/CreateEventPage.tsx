    ...
    <div className="space-y-8 pb-20 select-none animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-6" style={{ borderColor: activeTheme.borderColor }}>
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            <Trash2 className="w-4 h-4" style={{ color: activeTheme.primaryColor }} />
            <span>Delete</span>
          </button>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start relative">
        ...
        <div className={`${isConfigExpanded ? 'xl:col-span-9' : 'xl:col-span-12'} space-y-6 transition-all duration-300`}>
          ...
          <div className="bg-white rounded-2xl border shadow-xs overflow-visible" style={{ backgroundColor: activeTheme.cardColor, borderColor: activeTheme.borderColor }}>
            {/* Title Bar */}
          ...
          <div className="px-6 py-2 grid grid-cols-1 md:grid-cols-4 gap-2 items-center">
            ...
            <div className={`md:col-span-3 relative max-w-2xl ${activeDropdown === 'timezone' ? 'z-40' : 'z-30'}`}>
              <button
                type="button"
          ...
          <div className="px-6 py-2 grid grid-cols-1 md:grid-cols-4 gap-2 items-center">
            ...
            <div className={`md:col-span-3 relative max-w-2xl ${activeDropdown === 'eventType' ? 'z-40' : 'z-20'}`}>
              <button
                type="button"
          ...
          <div className="px-6 py-2 grid grid-cols-1 md:grid-cols-4 gap-2 items-center">
            ...
            <div className={`md:col-span-3 max-w-2xl relative ${activeDropdown === 'currency' ? 'z-40' : 'z-20'}`}>
              <button
                type="button"
          ...
          <div className="px-6 py-2.5 grid grid-cols-1 md:grid-cols-4 gap-2 items-start">
            ...
            <div className="md:col-span-3 max-w-2xl space-y-3">
              ...
              <div className={`relative ${activeDropdown === 'image' ? 'z-40' : 'z-10'}`}>
                <button
                  type="button"
              ...
              {!pdfSummaryFile ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-7 h-7 rounded-lg flex items-center justify-center transition-all hover:bg-neutral-100 border border-neutral-250 cursor-pointer"
                    style={{ borderColor: activeTheme.borderColor }}
                    title="Remove PDF"
                  >
                    <Trash2 className="w-3.5 h-3.5" style={{ color: activeTheme.primaryColor }} />
                  </button>
                </div>
              )}
            </div>
      ...
      <div className="space-y-6">
        ...
        <div 
          className="bg-white rounded-2xl border shadow-xs overflow-visible"
          style={{ 
        ...
        >
          <div className="p-4 px-5 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex flex-wrap items-center gap-x-8 gap-y-4">
              ...
              <div className={`flex items-center gap-3 relative ${activeDropdown === 'selectedRegType' ? 'z-40' : 'z-30'}`}>
              ...
              {eventData.availableRegistrations.map((reg, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-5 h-5 rounded-md flex items-center justify-center transition-all hover:bg-neutral-100 border border-neutral-250 cursor-pointer flex-shrink-0"
                    style={{ borderColor: activeTheme.borderColor }}
                    title="Remove registration"
                  >
                    <Trash2 className="w-3 h-3" style={{ color: activeTheme.primaryColor }} />
                  </button>
                </div>
              ))}
