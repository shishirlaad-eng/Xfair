            ...
            {checklist.map(item => (
              <div key={item.id} className="p-3.5 flex items-center justify-between bg-white hover:bg-neutral-50/50" style={{ backgroundColor: activeTheme.cardColor }}>
                ...
                <button
                  ...
                  className="text-neutral-300 p-1 rounded-lg transition-colors cursor-pointer"
                  style={{ color: '#D4D4D8' }}
                  onMouseEnter={(e) => e.currentTarget.style.color = activeTheme.primaryColor}
                ...
                <div key={book.id} className="p-4 border rounded-xl bg-neutral-50 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="text-neutral-300 p-1.5 rounded-lg hover:bg-neutral-100 transition-colors cursor-pointer"
                      style={{ color: '#D4D4D8' }}
                      onMouseEnter={(e) => e.currentTarget.style.color = activeTheme.primaryColor}
                      onMouseLeave={(e) => e.currentTarget.style.color = '#D4D4D8'}
                    >
                ...
                <div key={dev.id} className="py-3.5 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className="text-neutral-300 p-1 rounded-md hover:bg-neutral-100 transition-colors cursor-pointer"
                      style={{ color: '#D4D4D8' }}
                      onMouseEnter={(e) => e.currentTarget.style.color = activeTheme.primaryColor}
                      onMouseLeave={(e) => e.currentTarget.style.color = '#D4D4D8'}
                    >
                ...
                <tr key={idx} className="hover:bg-neutral-50/20">
                  ...
                  <td className="py-3.5 text-right space-x-1 whitespace-nowrap">
                    <button
                      ...
                      className="text-neutral-400 p-1.5 rounded-lg hover:bg-neutral-100 transition-colors cursor-pointer"
                      style={{ color: '#A3A3A3' }}
                      onMouseEnter={(e) => e.currentTarget.style.color = activeTheme.primaryColor}
