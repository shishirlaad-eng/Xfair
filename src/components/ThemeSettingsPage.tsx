                ...
                {!filesState.logo ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-7 h-7 rounded-lg flex items-center justify-center transition-all border cursor-pointer hover:opacity-85"
                      style={{ 
                        backgroundColor: `${activeTheme.primaryColor || '#f89728'}12`, 
                        borderColor: `${activeTheme.primaryColor || '#f89728'}25`, 
                        color: activeTheme.primaryColor || '#f89728' 
                      }}
                      title="Remove logo"
                    >
                      <Trash2 className="w-3.5 h-3.5" style={{ color: activeTheme.primaryColor || '#f89728' }} />
                    </button>
                  </div>
                )}
              </div>
